% This file was created by Yanxi Jiang, the the University of Nottingham Ningbo China (UNNC).
% The aouthor modified the source code from the PolyU Beamer Slides and coded by Crumble Jon. 
...
% This beamer follows the visual identity of the University of Nottingham (UoN), the University of Nottingham Ningbo China (UNNC), and is also allow used by the University of Nottingham Malaysia (UNM).
...
% Please read UoN.sty doucment to adjust some key output.
\documentclass[10pt,aspectratio=169]{beamer}
\usepackage{UoN}

\title{Nottingham Beamer Presentation Theme}
...
\includegraphics[width=\textwidth]{source/UoN_Nottingham_Blue_Single_Color_logo_RGB}\\
\end{column}
\end{columns}
\end{frame}
...
\begin{itemize}
\item \href{https://www.tablesgenerator.com}{Online LaTex table code generator}
\item \href{https://www.tablesgenerator.com/latex_tables}{Free online bibliography file generator}
\item \href{https://www.latexlive.com/}{Online LaTex equations editor}
\end{itemize}
\end{frame}


\lastframe % add the last frame, also already defined in UoN package.
